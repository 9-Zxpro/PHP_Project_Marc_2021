              ...
              <div class="card-body">
				...
				if($rowemp=mysqli_fetch_array($resemp))
				{
				   ...
				   <div class="mb-3">
				    ...
				    <div class="mb-3">
				     <label for="mname" class="form-label">Date Of Birth:</label>
				      <input type="date" id="date" name="dob" class="form-control"  required  value="<?php echo $rowemp['dob']; ?>" >
					</div>
				  ...
				  <div class="mb-3">
				     ...
				     <textarea class="form-control" name="address" id="address" placeholder="Enter Employee Address" required>  
						<?php echo $rowemp['address']; ?>
					 </textarea>
				   </div>
